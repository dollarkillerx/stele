...
var file_stele_proto_rawDesc = []byte{
	...
	0x6c, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x74, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x32, 0x8d, 0x03, 0x0a, 0x05, 0x53, 0x74, 0x65, 0x6c, 0x65,
	...
	,
	...
	0x61, 0x74, 0x65, 0x2e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x53, 0x65, 0x74, 0x4b, 0x56, 0x73, 0x12,
	0x35, 0x0a, 0x0a, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x53, 0x63, 0x61, 0x6e, 0x12, 0x10, 0x2e,
	0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x2e, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x1a,
	0x15, 0x2e, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x2e, 0x42, 0x61, 0x74, 0x63, 0x68,
	0x53, 0x65, 0x74, 0x4b, 0x56, 0x73, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x3b, 0x67, 0x65, 0x6e, 0x65,
...
var file_stele_proto_depIdxs = []int32{
	...
	5, // 3: generate.Stele.BatchSet:input_type -> generate.BatchSetKVs
	1, // 4: generate.Stele.BatchGet:input_type -> generate.SteleKS
	7, // 5: generate.Stele.IterateKeys:input_type -> generate.SteleRequest
	7, // 6: generate.Stele.IterateKeysAndValues:input_type -> generate.SteleRequest
	0, // 7: generate.Stele.PrefixScan:input_type -> generate.Prefix
	6, // 8: generate.Stele.Set:output_type -> generate.SteleStatus
	3, // 9: generate.Stele.Get:output_type -> generate.SteleVal
	6, // 10: generate.Stele.BatchSet:output_type -> generate.SteleStatus
	5, // 11: generate.Stele.BatchGet:output_type -> generate.BatchSetKVs
	1, // 12: generate.Stele.IterateKeys:output_type -> generate.SteleKS
	5, // 13: generate.Stele.IterateKeysAndValues:output_type -> generate.BatchSetKVs
	5, // 14: generate.Stele.PrefixScan:output_type -> generate.BatchSetKVs
